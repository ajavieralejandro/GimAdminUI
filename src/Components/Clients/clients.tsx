...
const Clients = () =>{
    ...
    <div className="container px-6 py-10 mx-auto">
        <h1 className="text-2xl font-semibold text-center text-gray-800 capitalize lg:text-3xl ">Our <span className="text-blue-500">Executive Team</span></h1>
        ...
        <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-2">
            <div className="px-12 py-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-blue-600 dark:border-gray-700 dark:hover:border-transparent">
                <div className="flex flex-col sm:-mx-4 sm:flex-row">
                    ...
                    <div className="mt-4 sm:mx-4 sm:mt-0">
                        ...
                        <p className="mt-2 text-black capitalize text-black group-hover:text-gray-300">design director</p>
                    </div>
                </div>

                <p className="mt-4 text-black capitalize text-black group-hover:text-gray-300">Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum nesciunt officia aliquam neque optio? Cumque facere numquam est.</p>

                <div className="flex mt-4 -mx-2">
                    <a href="#" className="mx-2 text-gray-600 text-black hover:text-black dark:hover:text-gray-300 group-hover:text-black" aria-label="Reddit">
                    ...
                    <a href="#" className="mx-2 text-gray-600 text-black hover:text-black dark:hover:text-gray-300 group-hover:text-black" aria-label="Facebook">
                        <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <a href="#" className="mx-2 text-gray-600 text-black hover:text-black dark:hover:text-gray-300 group-hover:text-black" aria-label="Github">
                        <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
            ...
            <div className="px-12 py-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-blue-600 dark:border-gray-700 dark:hover:border-transparent">
                <div className="flex flex-col sm:-mx-4 sm:flex-row">
                    ...
                    <div className="mt-4 sm:mx-4 sm:mt-0">
                        <h1 className="text-xl font-semibold text-gray-700 capitalize md:text-2xl  group-hover:text-black">Amelia. Anderson</h1>

                        <p className="mt-2 text-black capitalize text-black group-hover:text-gray-300">Lead Developer</p>
                    </div>
                </div>
            ...
            <div className="px-12 py-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-blue-600 dark:border-gray-700 dark:hover:border-transparent">
                <div className="flex flex-col sm:-mx-4 sm:flex-row">
                    ...
                    <div className="mt-4 sm:mx-4 sm:mt-0">
                        <h1 className="text-xl font-semibold text-gray-700 capitalize md:text-2xl  group-hover:text-black">Olivia Wathan</h1>

                        <p className="mt-2 text-black capitalize text-black group-hover:text-gray-300">Lead designer</p>
                    </div>
                </div>
            ...
            <div className="px-12 py-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-blue-600 dark:border-gray-700 dark:hover:border-transparent">
                <div className="flex flex-col sm:-mx-4 sm:flex-row">
                    ...
                    <div className="mt-4 sm:mx-4 sm:mt-0">
                        <h1 className="text-xl font-semibold text-gray-700 capitalize md:text-2xl  group-hover:text-black">John Doe</h1>

                        <p className="mt-2 text-black capitalize text-black group-hover:text-gray-300">Full stack developer</p>
                    </div>
                </div>

            ...
            <div className="w-full py-6 z-20">
                ...
                <form action="" className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                    <div className="pb-2 pt-4">
                        <input type="email" name="email" id="email" placeholder="Email" className="block w-full border border-gray-300 p-4 text-lg rounded-sm bg-white" />
                    </div>
                    <div className="pb-2 pt-4">
                        <input className="block w-full p-4 border border-gray-300 text-lg rounded-sm bg-white" type="password" name="password" id="password" placeholder="Password" />
                    </div>
                    <div className="pb-2 pt-4">
                        <CajaDropdown />
                    </div>
                    ...
                    <div className="px-4 pb-2 pt-4">
                        <button className="uppercase bg-blue-500 block w-full p-4 text-lg rounded-full  hover:bg-indigo-600 focus:outline-none">sign in</button>
                    </div>
